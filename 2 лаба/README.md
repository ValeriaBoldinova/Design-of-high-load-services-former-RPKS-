...
**Основные запросы для проверки (при работе в терминале выполнять каждую группу запросов отдельно):**
...
**Основные запросы для проверки (в терминале каждую группу запросов выполнять отдельно (витрины тоже по одной выполнять)):**
